      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 bg-gradient-to-br from-green-600 to-green-800 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-green-200 transition-shadow">
              <img src="/logo.png" alt="C.E.G Logo" className="w-5 h-5 absolute" />
            </div>
            <div className="hidden sm:block">
              <p className="font-bold text-green-800 text-sm leading-tight font-poppins">C.E.G</p>
              <p className="text-xs text-gray-500 leading-tight">Club Environnemental de Guinée</p>
            </div>
          </Link>
