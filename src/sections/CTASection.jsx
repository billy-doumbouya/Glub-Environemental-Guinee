      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative">
            <motion.span
              variants={fadeUp}
              className="inline-flex items-center gap-2 bg-white/20 text-white text-xs font-semibold px-4 py-1.5 rounded-full mb-6 border border-white/30"
            >
              Rejoignez notre mission
            </motion.span>
            <motion.h2
              variants={fadeUp}
              className="font-poppins font-bold text-4xl md:text-5xl text-white mb-6 leading-tight"
            >
            ...
            <motion.p
              variants={fadeUp}
              className="text-green-100 text-lg max-w-2xl mx-auto mb-10 leading-relaxed"
            >
              Que vous soyez partenaire, bailleur, chercheur ou citoyen engagé,
              votre soutien à ONG C.E.G amplifie l'impact de nos actions
            ...
            >
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 bg-white text-green-700 px-8 py-4 rounded-2xl font-semibold text-base transition-all duration-200 hover:scale-105 shadow-xl"
              >
