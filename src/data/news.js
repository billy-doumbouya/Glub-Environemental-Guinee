export const news = [
  {
    ...
    title: 'C.E.G célèbre la Journée Mondiale de l\'Environnement 2024',
    excerpt:
    ...
    content:
      "Le 5 juin 2024, l'ONG C.E.G a mobilisé plus de 500 participants pour une journée de reboisement et de sensibilisation environnementale dans la préfecture de Forécariah...",
    date: '05 Juin 2024',
    category: 'Événement',
    image: null,
    author: 'Équipe  ONG C.E.G',
  ...
  },
  {
    ...
    title: 'Renouvellement du partenariat avec le SGP/FEM',
    excerpt:
    ...
    image: null,
    author: 'Direction  ONG C.E.G',
    tags: ['Partenariat', 'SGP', 'FEM', 'Financement'],
    featured: true,
  },
  {
    id: 4,
    ...
    excerpt:
      "Le rapport annuel 2023 de l'ONG  ONG C.E.G est désormais disponible, illustrant les réalisations et l'impact de l'organisation sur l'année écoulée.",
    content:
      "L'ONG  ONG C.E.G publie son rapport annuel 2023 qui retrace les activités, les résultats et l'impact de ses interventions...",
