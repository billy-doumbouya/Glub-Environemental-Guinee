        ...
        <div className={`grid lg:grid-cols-2 gap-16 items-center ${isEven ? '' : 'lg:grid-flow-col-dense'}`}>
          ...
          >
            ...
            <div
              ...
              style={{ backgroundColor: domain.bgColor, borderColor: `${domain.color}30` }}
            >
          ...
          >
            <div
              ...
              style={{ background: `linear-gradient(135deg, ${domain.color}, ${domain.color}aa)` }}
            >
              ...
              <div className="relative text-center text-white p-8">
                ...
                <p className="font-poppins font-bold text-2xl mb-2">{domain.shortTitle}</p>
